...
export const hiringPostScheduledMaxPosts = Number.isFinite(envMaxPosts) && envMaxPosts > 0
  ...
  : 10;
/**
 * Sized so the rotation tiles the 24h postedLimit window exactly: any list of
 * 81 to 96 companies at 16 per batch is 6 batches, and 6 x the 4h cadence is a
 * 24h cycle. Crossing either end of that range retimes the cycle. At 20
