...
const technicalFamilies: Array<{
  ...
  },
  {
    ...
    reason: "Matched security, application security, product security, cyber, IAM, threat intelligence, detection and response, or SOC title.",
    patterns: [
      /\bsecurity\b/iu,
      /\bcybersecurity\b/iu,
      /\bcyber\b/iu,
      ...
      /\bthreat intelligence\b/iu,
      /\bthreat detection\b/iu,
      /\bthreat hunt(er|ing)\b/iu,
      /\bdetection (and|&) response\b/iu,
      /\bincident response\b/iu,
      /\bvulnerability (management|research|analyst)\b/iu,
      /\bpenetration test(er|ing)?\b/iu,
      /\bred team\b/iu,
      /\bappsec\b/iu,
      /\bSOC (engineer|analyst)\b/iu,
    ],
  },
  {
