        ...
        <section className="mb-6 flex flex-wrap items-end justify-between gap-x-8 gap-y-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs font-bold text-slate-600">
            <span className="card inline-flex items-center gap-2 px-3 py-2">
              <Icon name="layers" className="h-3.5 w-3.5 text-slate-400" /> {data.feed.posts.length} signals
            </span>
            <span className="card inline-flex items-center gap-2 px-3 py-2">
              <Icon name="code" className="h-3.5 w-3.5 text-sky-700" /> {technicalCount} technical
            </span>
            <span className="card inline-flex items-center gap-2 px-3 py-2">
              <Icon name="users" className="h-3.5 w-3.5 text-emerald-700" /> {nonTechnicalCount} non-tech
            </span>
            <span className="card inline-flex items-center gap-2 px-3 py-2">
              <Icon name="refresh" className="h-3.5 w-3.5 text-amber-700" /> {hiringPostScanCadenceHours}h batch
            </span>
          </div>
        </section>
